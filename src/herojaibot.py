...
users = {"veikejas1": "veikejoPrisijungimoPaslaptis",
...
def fight(character: str, gathered_resources: dict, agent: str, imin: int, imax: int, i: str, j: str, k: str, cooldown: float,
